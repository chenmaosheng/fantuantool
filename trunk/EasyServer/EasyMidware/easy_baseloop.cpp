...
int32 EasyBaseLoop::Init(EasyBaseServer* pServer)
{
	...
	m_pMainLoop = this;
	EasyBaseSession::Initialize(pServer);
	return 0;
}
...
bool EasyBaseLoop::IsReadyForShutdown() const
{
	return m_iShutdownStatus == READY_FOR_SHUTDOWN;
}

void EasyBaseLoop::_ReadyForShutdown()
{
